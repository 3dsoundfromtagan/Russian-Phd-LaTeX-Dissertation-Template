...
\begin{frame}[plain, noframenumbering]
	...
	\begin{columns}[t]
		...
		\begin{itemize}
			...
			\item Практичность → большая длина волокна доставки
			\item Следствие: нелинейные эффекты второго и третьего порядка
		...
		\begin{column}{0.4\textwidth}
			...
			\begin{itemize}
				\item Разогрев за счёт оптического поглощения → необходимость прецизионного определения				
			\end{itemize}
		\end{column}
	\end{columns}
\end{frame}
