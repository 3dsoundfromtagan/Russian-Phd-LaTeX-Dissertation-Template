\chapter{Нелинейно-оптические эффекты третьего порядка в оптическом волокне}\label{ch:ch1}

\section{Поперечные моды оптического волокна}\label{sec:ch1/sec1}
Ссылка на меня \cite{imfwm}.
